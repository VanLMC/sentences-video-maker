...
for %%g in (content/audios/*) do (
   ...
   ffmpeg -y -loop 1 -i content/images/!i!-sentence.png -i content/audios/!i!.mp3 -threads 2 -c:v libx264 -c:a aac -b:a 192k -vf format=yuv420p -shortest content/videos/!i!.mp4
   set /A i+=1
   echo !i!
